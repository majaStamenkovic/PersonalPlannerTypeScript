...
app.use('/fakultet',verifikacija, new FakultetRouter().routes);
app.use('/sport',verifikacija, new SportRouter().routes);
app.use('/drustvo',verifikacija, new DrustvoRouter().routes);
